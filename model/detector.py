...
from model.backbone.pplcnet import *
...
class Detector(nn.Module):
    def __init__(self, classes, anchor_num, load_param, export_onnx = False):
        ...
        # stage_out_channels = [-1, 24, 44, 88, 176]
        # self.backbone = PPLCNet_x0_35()

        # stage_out_channels = [-1, 24, 64, 128, 256]
        # self.backbone = PPLCNet_x0_5()

        # stage_out_channels = [-1, 24, 48, 64, 80]
        # self.backbone = mobilevit_xxs((256, 256))
    ...
    def forward(self, x):
        ...
        if self.export_onnx:
            ...
            out_cls_2 = out_cls_2.softmax(dim=1)

            out_reg_3 = out_reg_3.sigmoid()
            out_obj_3 = out_obj_3.sigmoid()
            out_cls_3 = out_cls_3.softmax(dim=1)
